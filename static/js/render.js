    ...
    return `
        <div class="competition-section" id="${sectionId}">
            <div class="comp-header" onclick="toggleSection('${sectionId}')">
                <img class="comp-header-emblem" src="${config.league_image_url.replace('{id}', ut.id)}" alt="${ut.name}">
    ...
    return `
        <div class="match-card" id="match-${ev.id}${suffix}" onclick="window.location.href='/match/${ev.id}'">
            ...
            <div class="team-col home">
                <img class="team-crest" src="${config.team_image_url.replace('{id}', home.id)}">
            ...
            <div class="team-col away">
                <img class="team-crest" src="${config.team_image_url.replace('{id}', away.id)}">
            ...
            <div class="player-hero">
                ...
                <div class="player-hero-content">
                    <div class="player-hero-portrait">
                        <img src="${config.player_image_url.replace('{id}', p.id)}" onerror="this.src='/static/img/player-placeholder.png';">
                    </div>
                    <div class="player-hero-info">
                        ${team.id ? `
                            <div class="player-hero-team-badge">
                                <img src="${config.team_image_url.replace('{id}', team.id)}">
                                <span>${team.name}</span>
                            </div>
                        ` : ''}
        ...
        <div class="page-content">
            <div class="section-card">
                <div class="section-card-header" style="display:flex;align-items:center;gap:16px;">
                    <img src="${config.team_image_url.replace('{id}', t.id)}" style="width:48px;height:48px;object-fit:contain;">
...
async function renderCompetition(id, sid) {
    ...
    area.innerHTML = `
        <div class="page-content">
            <div class="section-card">
                <div class="section-card-header" style="display:flex;align-items:center;gap:16px;">
                    <img src="${config.league_image_url.replace('{id}', comp.id)}" style="width:48px;height:48px;object-fit:contain;">
        ...
        <div class="page-content">
            <div class="match-card-hero" style="text-align:center;padding:40px;background:var(--bg-card);border-radius:12px;border:1px solid var(--border);">
                <div style="display:flex;justify-content:center;align-items:center;gap:40px;">
                    <div>
                        <img src="${config.team_image_url.replace('{id}', ev.homeTeam.id)}" style="width:80px;height:80px;">
                    ...
                    <div>
                        <img src="${config.team_image_url.replace('{id}', ev.awayTeam.id)}" style="width:80px;height:80px;">
